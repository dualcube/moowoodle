...
?> <p> <?php
		...
		echo esc_html__( 'Password : 1Admin@23', 'moowoodle' ) . '<br><br>';
		echo esc_html__( 'To enroll and access your course please click on the course link given below :', 'moowoodle' ) . '<br><br>';
?> </p> <?php
...
?> <p> <?php echo esc_html__( 'You need to change your password after first login.', 'moowoodle' ) . '<br><br>'; ?> </p> <?php
