...
const MyClassroom = () => {
  ...
  const handleUpdateClassroom = async group => {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_5__["default"].post((0,_services_apiService__WEBPACK_IMPORTED_MODULE_1__.getApiLink)("rename-classroom"), {
        id: group.group_id,
        new_name: newName
      }, {
        headers: {
...
const ViewEnroll = ({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("button", {
      ...
      children: classroom.items.map(course => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_CourseCard__WEBPACK_IMPORTED_MODULE_3__["default"], {
        course: course
      }, course.course_id))
