  ...
  public function moowoodle_plugin_options_tabs() {
    ...
    if ($uses_tabs) {
      ...
      if( apply_filters( 'moowoodle_free_active', true ) ){
        echo '<a class="nav-tab moowoodle-upgrade" href="https://dualcube.com/shop/" target="_blank" rel="noopener noreferrer"><i class="fas fa-trophy"></i> '.__('Upgrade to Pro for More Features', 'moowoodle').'</a>';
      }
