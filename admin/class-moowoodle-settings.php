...
if ($MooWoodle->moowoodle_pro_adv) {
          ...
          <h2>' . esc_html__('Upgrade to Moowoodle Pro', MOOWOODLE_TEXT_DOMAIN) . '</h2>
          <h3 class="mw-banner-thrd">' . esc_html__('Activate 30+ Pro Modules', MOOWOODLE_TEXT_DOMAIN) . '</h3>
          <p>' . esc_html__('Enable this Modules by upgrading to our Pro Plan, and
          unleash your preferred modules to supercharge
          your website potential!', MOOWOODLE_TEXT_DOMAIN) . '</p>
          <div class="mw-banner-offer">Today Offer</div>
          <div class="discount-tag">Upto <b>20%</b>Discount</div>
          <p class="">Why wait, grab the 15% discount and enjoy using Pro
          with unlimited features.</p>
