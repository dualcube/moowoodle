...
class DC_Woodle_Emails_New_Account extends WC_Email {
  ...
  function __construct() {
    ...
    $this->id 				= 'new_moodle_account';
    $this->title 			= __( 'New Moodle Account', $DC_Woodle->text_domain );
    $this->description		= __( 'This is a notification email sent to the enrollees for new moodle account.', $DC_Woodle->text_domain );

    $this->heading 			= __( 'New Account', $DC_Woodle->text_domain );
    $this->subject      	= __( '{site_title} New Account', $DC_Woodle->text_domain );

    $this->template_html 	= 'emails/new-account.php';
    $this->template_plain 	= 'emails/plain/new-account.php';
