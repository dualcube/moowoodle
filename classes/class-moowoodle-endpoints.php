...
class MooWoodle_Endpoints {
  ...
  function woocommerce_account_my_courses_endpoint() {
    ...
    $pwd = get_user_meta( $customer->ID , '_moodle_user_pwd', true );
            ...
            <tbody>
              ...
              foreach ( $customer_orders as $customer_order ) {
                ...
                foreach ( $order->get_items() as $enrolment ) {
                  ...
                  $enrollment_list = get_moowoodle_course_url( $linked_course_id, 'View' );
                  $enrolment_date = get_post_meta( $order->get_id(), 'enrolment_date', true );
                  ?>
                  <tr>
                    <td>
                    ...
                    <td>
                      <?php 
                      echo '<button type="button" class="button-tri">' . $enrollment_list . '<i class="fas fa-eye"></i>' . '</button>';
                      ?>
                    </td>
                  </tr>              
                <?php
