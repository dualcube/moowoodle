...
class Util {
	...
	public static function log( $message, $clear = true ) {
		...
		if( $message != '' ) {
			...
			$existing_content = $wp_filesystem->get_contents( get_site_url( null, str_replace( ABSPATH, '', MooWoodle()->get_moowoodle_log_file() ) ) );
			...
			return $wp_filesystem->put_contents( MooWoodle()->get_moowoodle_log_file(), $existing_content . $log_entry );
		}
