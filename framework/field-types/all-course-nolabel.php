...
$args = array(
	...
	'lang' => array(
		'Search_Course' => __("Search Course", 'moowoodle'),
        'select_bulk_action' => __('Select bulk action', 'moowoodle'),
        'bulk_actions' => __('Bulk Actions', 'moowoodle'),
        'sync_course' => __('Sync Course', 'moowoodle'),
        'create_product' => __('Create Product', 'moowoodle'),
        'update_product' => __('Update Product', 'moowoodle'),
        'apply' => __('Apply', 'moowoodle'),
	),
