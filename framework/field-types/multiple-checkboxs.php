             ...
             <div class="mw-col-50 <?php echo (isset($checkbox_options['is_pro']) && ($checkbox_options['is_pro'] == 'pro') ? $pro_popup_overlay : ''); ?>">
                 <div class="mw-wrap-checkbox-and-label">
                     <div class="mw-normal-checkbox-content d-flex">
                         <input id="<?php echo $checkbox_options['id']; ?>" class="mw-toggle-checkbox <?php echo $checkbox_options['id']; ?>" value="Enable" type="checkbox" name="<?php echo $setting_id . '[' . $checkbox_options['name'] . ']'; ?>" value="general" <?php echo ((isset($options[$checkbox_options['name']]) ? $options[$checkbox_options['name']] == "Enable" : '') ? 'checked' : '') . ' ' . (isset($checkbox_options['is_pro']) && ($checkbox_options['is_pro'] == 'pro') && ($MooWoodle->moowoodle_pro_adv) ? ' disabled ' : '') . ((isset($checkbox_options['checked']) && $checkbox_options['checked'] == 'forced') ? ' checked disabled ' : ''); ?>>
