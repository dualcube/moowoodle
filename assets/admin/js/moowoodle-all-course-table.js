(function($) {
    ...
    $(document).ready(function() {
       ...
       var columnsData = [];
        ...
        $('<div class="mw-header-search-section"><label class="moowoodle-course-search"><i class="dashicons dashicons-search"></i></label><input type="search" class="moowoodle-search-input" placeholder="' + table_args.lang.Search_Course + '" aria-controls="moowoodle_table"></div>').appendTo($('.mw-header-search-wrap'));
