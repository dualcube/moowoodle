...
👥 **Moodle User [PRO]**:  Sync all existing users from Moodle to WordPress.


👥 **Wordpress User[PRO]**: Sync all existing users from  WordPress to Moodle.




👥 **Real Time User Sync[PRO]**:  If a user or admin makes changes to profile data in Moodle or WordPress, those modifications will be automatically updated in both Moodle and WordPress.
👥 **Bulk User Sync[PRO]**:  Administrators have the ability to select multiple users from the WordPress user tab and synchronize their data from WordPress to Moodle in bulk.


👥 **User Profile details Sync Option[PRO]**: You can select which profile details to be synced like Full Name, Password, Username.
