  ...
  if ( count( $customer_orders ) > 0 ) {
      ...
      foreach ( $customer_orders as $customer_order ) {
        ...
        foreach ( $order->get_items() as $enrolment ) {
          ...
          $course = get_posts( [ 'meta_key' => 'moodle_course_id', 'meta_value' =>  $course_id, 'post_type' => 'course', 'post_status' => 'publish' ] );
      ...
      <h3>
        Kindly purchase a Course and come back here to see your course.
      </h3>
      <?php
    }
}
